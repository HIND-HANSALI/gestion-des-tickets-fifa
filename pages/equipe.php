...
<body class="overflow-y-scroll">
     ...
     <div class=" position-relative header-themes">
        <div class="opa"></div>
     ...
     <div class="container">
        ...
        <div class="w-100 pt-4 d-flex justify-content-center">
            <div class="card w-100 " >
                <div class="pb-4">
                <img src="https://static.lematin.ma/files/lematin/images/articles/2022/12/cd3bc6e42e4c3fadcff0ef8fcdf96882.webp" class="card-img-top"  style="height: 30rem;" alt="stade 1">
                </div>
