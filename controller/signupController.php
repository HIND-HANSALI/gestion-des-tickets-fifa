...
include_once(dirname(__DIR__) .'/model/signup.php');
    ...
    public function addUser(){
        if($_SERVER['REQUEST_METHOD'] == 'POST'){
            if(isset($_REQUEST['signup'])){
                ...
                $this->signupUser($nameSignup,$emailSignup,$passwordSignup,$Repeatpassword);

            }
        }
    }

    public function signupUser($name,$email,$password,$RepeatPassword){
