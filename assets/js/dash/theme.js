...
var renderCalendar = function renderCalendar(el, option) {
    ...
    calendar.render();
    (_document$querySelect = document.querySelector('.navbar-vertical-toggle')) === null || _document$querySelect === void 0
        ? void 0
...
var getTemplate = function getTemplate(event) {
    return '\n<div class="modal-header bg-light ps-card pe-5 border-bottom-0">\n  <div>\n    <h5 class="modal-title mb-0">'
        ...
        .concat(document.location.href.split('/').slice(0, 5).join('/'), '/app/events/create-an-event.html" class="btn btn-falcon-default btn-sm">\n    <span class="fas fa-pencil-alt fs--2 mr-2"></span> Edit\n  </a>\n  <a href=\'')
        .concat(document.location.href.split('/').slice(0, 5).join('/'), '/app/events/event-detail.html\' class="btn btn-falcon-primary btn-sm">\n    See more details\n    <span class="fas fa-angle-right fs--2 ml-1"></span>\n  </a>\n</div>\n');
};
/* -------------------------------------------------------------------------- */
...
var audienceChartInit = function audienceChartInit() {
    ...
    var tooltipFormatter = function tooltipFormatter(params) {
        ...
        var perTemp = '\n      <div class="d-flex align-items-center ms-2">\n        <span class="fas fa-caret-'
            ...
            .concat(percentage < 0 ? 'danger' : 'success', '"></span>\n        <h6 class="fs--2 mb-0 ms-1 fw-semi-bold">')
...
var bounceRateChartInit = function bounceRateChartInit() {
    ...
    var tooltipFormatter = function tooltipFormatter(params) {
        return "<div>\n          <p class='mb-0 text-600'>"
            .concat(window.dayjs(params[0].axisValue).format('DD, MMMM'), '</p>\n          <div class="d-flex align-items-center">\n            <p class="mb-0 text-600">\n              Rate : <span class=\'text-800\'>')
    ...
    params.forEach(function (el) {
        tooltipItem =
            ...
            '<div class=\'ms-1\'> \n        <h6 class="text-700"><span class="fas fa-circle me-1 fs--2" style="color:'
                ...
                .concat(_typeof(el.value) === 'object' ? el.value[1] : el.value, '\n        </h6>\n      </div>');
    });
    return "<div>\n            <p class='mb-2 text-600'>\n              "
...
var locationBySessionInit = function locationBySessionInit() {
    ...
    if ($locationBySessionMap) {
            ...
            return {
                tooltip: {
                    ...
                    formatter: function formatter(params) {
                        ...
                        return '<strong>'
                            .concat((_params$data = params.data) === null || _params$data === void 0 ? void 0 : _params$data.name, ' :</strong> ')
                            .concat(((((_params$data2 = params.data) === null || _params$data2 === void 0 ? void 0 : _params$data2.value) / total) * 100).toFixed(2), '%');
                    },
                },
                visualMap: {
                    show: false,
        ...
        echartSetOption(chart, userOptions, getDefaultOptions);
        var zoomLevel = 1;
        (_document$querySelect2 = document.querySelector('.location-by-session-map-reset')) === null || _document$querySelect2 === void 0
            ? void 0
        ...
        (_document$querySelect3 = document.querySelector('.location-by-session-map-zoom')) === null || _document$querySelect3 === void 0
            ? void 0
        ...
        (_document$querySelect4 = document.querySelector('.location-by-session-map-zoomOut')) === null || _document$querySelect4 === void 0
            ? void 0
...
var sessionByCountryMapInit = function sessionByCountryMapInit() {
    ...
    if ($sessionByCountryMap) {
            ...
            return {
                tooltip: {
                    ...
                    formatter: function formatter(params) {
                        ...
                        return '<strong>'
                            .concat((_params$data3 = params.data) === null || _params$data3 === void 0 ? void 0 : _params$data3.name, ' :</strong> ')
                            .concat(((((_params$data4 = params.data) === null || _params$data4 === void 0 ? void 0 : _params$data4.value) / total) * 100).toFixed(2), '%');
                    },
                },
                toolbox: {
                    show: false,
        ...
        echartSetOption(chart, userOptions, getDefaultOptions);
        (_document$querySelect5 = document.querySelector('.session-by-country-map-reset')) === null || _document$querySelect5 === void 0
            ? void 0
...
var userByLocationInit = function userByLocationInit() {
    ...
    if ($userByLocationMap) {
            ...
            return {
                tooltip: {
                    ...
                    formatter: function formatter(params) {
                        ...
                        return '<strong>'
                            .concat((_params$data5 = params.data) === null || _params$data5 === void 0 ? void 0 : _params$data5.name, ' :</strong> ')
                            .concat((_params$data6 = params.data) === null || _params$data6 === void 0 ? void 0 : _params$data6.value);
                    },
                },
                visualMap: {
                    show: false,
        ...
        echartSetOption(chart, userOptions, getDefaultOptions);
        var zoomLevel = 1;
        (_document$querySelect6 = document.querySelector('.user-by-location-map-zoom')) === null || _document$querySelect6 === void 0
            ? void 0
        ...
        (_document$querySelect7 = document.querySelector('.user-by-location-map-zoomOut')) === null || _document$querySelect7 === void 0
            ? void 0
...
var usersByTimeChartInit = function usersByTimeChartInit() {
    ...
    var tooltipFormatter = function tooltipFormatter(params) {
        return "<div>\n          <p class='mb-0 text-600'>"
            .concat(window.dayjs(params.name).format('MMM DD, YYYY'), '</p>\n          <div class="d-flex align-items-center">\n            <p class="mb-0 text-600">\n              ')
            .concat(window.dayjs().hour(params.data[1]).format('hA'), " : <span class='text-800 fw-semi-bold'>")
